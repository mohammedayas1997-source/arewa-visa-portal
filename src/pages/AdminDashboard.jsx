      ...
      >
        <div className="text-center mb-4">
          ...
          <h3 className="fw-bold text-white">
            <ShieldAlert className="d-inline me-2" />
            AVA Admin
          </h3>
...
const GlobalAdminDashboard = () => {
  ...
  const handleUploadTickets = async () => {
    if (!ticketPoolInput.trim())
      return alert("Please paste ticket numbers first!");

    setUploading(true);
    try {
      const ticketsArray = ticketPoolInput
        .split(/[\n,]+/)
        .map((t) => t.trim())
        .filter((t) => t !== "");
      ...
      logAction(
        "TICKET_UPLOAD",
        `Uploaded ${ticketsArray.length} new tickets to inventory`,
      );
      setTicketPoolInput("");
  ...
  const handleRejectTicket = async (booking) => {
    if (
      window.confirm(
        `Are you sure you want to reject ${booking.customerName}'s ticket?`,
      )
    ) {
      try {
        ...
        logAction(
          "TICKET_REJECTED",
          `Rejected ticket ${booking.ticketNo} for ${booking.customerName}.`,
        );
  ...
  const approveAndSendCertificate = async (student) => {
    ...
    try {
      ...
      await set(ref(db, `training/${student.id}/certInfo`), {
        certificateID,
        completionDate,
        courseTitle,
  ...
  return (
    <div className="min-h-screen bg-light d-flex d-print-block">
      <aside
        className="bg-dark text-white p-3 shadow-lg d-none d-md-block d-print-none"
      ...
      >
        ...
        <nav className="nav flex-column gap-2">
          <button
            ...
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent ${activeTab === "overview" ? "bg-danger shadow" : ""}`}
          >
            <TrendingUp size={20} /> Overview
          </button>
          <button
            onClick={() => setActiveTab("applications")}
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent ${activeTab === "applications" ? "bg-danger shadow" : ""}`}
          >
            <Users size={20} /> Job Applications
          </button>
          <button
            onClick={() => setActiveTab("training")}
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent ${activeTab === "training" ? "bg-danger shadow" : ""}`}
          >
            <GraduationCap size={20} /> Training Apps
          </button>
          <button
            onClick={() => setActiveTab("manpower")}
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent ${activeTab === "manpower" ? "bg-danger shadow" : ""}`}
          >
            <Building2 size={20} /> Manpower Requests
          </button>
          <button
            onClick={() => setActiveTab("finance")}
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent ${activeTab === "finance" ? "bg-danger shadow" : ""}`}
          >
            <Wallet size={20} /> Revenue Tracker
          </button>
          <button
          ...
          <button
            ...
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent ${activeTab === "history" ? "bg-danger shadow" : ""}`}
          >
            <History size={20} /> Activity History
          </button>
          <button
            onClick={() => setActiveTab("cbi")}
            className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent w-100 transition-all ${activeTab === "cbi" ? "bg-warning shadow text-dark fw-bold" : "hover-bg-light-opacity"}`}
          >
            <Globe
              size={20}
              className={activeTab === "cbi" ? "text-dark" : "text-warning"}
            />
            <span>CBI Applications</span>
          </button>
        </nav>
        <div className="mt-auto p-3 text-secondary small">
          <ShieldAlert size={14} /> Secured Session
        </div>
      </aside>
      ...
      <main className="flex-grow-1 p-4 overflow-auto">
        <header className="d-flex justify-content-between align-items-center mb-4 bg-white p-3 rounded-4 shadow-sm d-print-none">
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted small mb-0">
                <Clock size={12} /> {new Date().toDateString()} | Live Data
                Connected
              </p>
            </div>
          </div>
          <div className="d-flex gap-2">
            <button
              onClick={handlePrint}
              className="btn btn-light border btn-sm rounded-pill px-3 d-flex align-items-center gap-2"
            >
        ...
        <div className="row g-4 mb-4 text-nowrap">
          ...
          <div className="col-md-3">
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-white text-center">
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <UserCheck size={18} className="text-danger" />
              </div>
          ...
          <div className="col-md-3">
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-white text-center">
              <div className="d-flex justify-content-between align-items-center mb-2">
                <h6 className="text-success">Students</h6>
          ...
          <div className="col-md-3">
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-white text-center">
              <div className="d-flex justify-content-between align-items-center mb-2">
                <h6 className="text-primary">Companies</h6>
          ...
          <div className="col-md-6">
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-white">
              <h5 className="fw-bold mb-3 text-danger">
                <Newspaper size={20} className="me-2" /> Post Latest News
              </h5>
              <form onSubmit={handlePostNews}>
                ...
                <button
                  ...
                  disabled={uploading}
                >
                  {uploading ? "Posting..." : "Publish News"}
                </button>
              </form>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-white">
              <h5 className="fw-bold mb-3 text-primary">
                <ImagePlus size={20} className="me-2" /> Add to Gallery
              </h5>
              <p className="small text-muted">
                Select a photo to display on the home page gallery.
              </p>
          ...
          <div className="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
            <div className="p-3 border-bottom d-flex justify-content-between align-items-center">
              <span className="fw-bold">
                <Search size={16} className="me-2" /> Recent Job Seekers
              </span>
                  ...
                  {applications.map((app) => (
                    <tr key={app.id}>
                      <td className="ps-4">
                        <div className="d-flex align-items-center gap-3">
                          <div className="position-relative">
                            <img
                              src={
                                app.photoUrl || "https://via.placeholder.com/40"
                              }
                            ...
                            <CheckCircle
                              size={12}
                              className="position-absolute bottom-0 end-0 text-success bg-white rounded-circle"
                            />
                          </div>
                          <div>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <a
                            href={`mailto:${app.email}?subject=Update on your Job Application`}
                      ...
                      <td>
                        <div className="d-flex align-items-center gap-2">
                          <button
                            onClick={() =>
                              handleDelete(app.id, "app", app.name)
                            }
              ...
              <div className="d-flex justify-content-between align-items-center mb-4 text-dark border-bottom pb-3">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <h5 className="fw-bold mb-0">
                    Ticket Inventory & Auto-Distribution
                  </h5>
                </div>
              ...
              <div className="row g-4">
                <div className="col-md-7">
                  <div className="p-4 border rounded-4 bg-light shadow-sm text-dark">
                    <h6 className="fw-bold mb-3 d-flex align-items-center gap-2">
                      <Send size={18} className="text-primary" /> Upload Ticket
                      Pool
                    </h6>
                    <label className="small fw-bold text-muted mb-2 text-uppercase">
                      Input 10 Ticket Numbers (One per line)
                    </label>
                    <textarea
                ...
                <div className="col-md-5">
                  <div className="card border-0 bg-dark text-white p-4 h-100 rounded-4 shadow-lg overflow-hidden">
                    ...
                    />
                    <h6 className="fw-bold text-warning mb-4 text-uppercase small">
                      Inventory Status
                    </h6>
                    ...
                    <div className="mt-4 p-3 rounded-3 bg-secondary bg-opacity-25 border border-secondary">
                      <small className="text-warning fw-bold">
                        <AlertCircle size={14} /> Automatic System:
                      </small>
                      <p className="mb-0" style={{ fontSize: "11px" }}>
                        Rejected tickets automatically return to pool and expire
                        from user dashboard.
                      </p>
                    </div>
                  </div>
            ...
            <div className="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
              <div className="p-3 border-bottom d-flex justify-content-between align-items-center bg-light">
                <span className="fw-bold text-dark d-flex align-items-center gap-2">
                  <Users size={18} className="text-danger" /> Live Booking Logs
                  & Transactions
                </span>
                <div className="d-flex gap-2">
                  <button className="btn btn-sm btn-white border rounded-pill px-3 small fw-bold">
                    All
                  </button>
                  <button className="btn btn-sm btn-white border rounded-pill px-3 small">
                    Sold
                  </button>
                  <button className="btn btn-sm btn-white border rounded-pill px-3 small">
                    Rejected
                        ...
                        <tr key={b.id}>
                          ...
                          <td>
                            ...
                            <div
                              ...
                              style={{ fontSize: "11px" }}
                            >
                              <Wallet size={10} className="me-1" /> {b.bankName}{" "}
                              | {b.accountNo}
                            </div>
                          </td>
                          <td>
                            <span
                              className={`badge rounded-pill px-3 ${b.status === "Rejected" ? "bg-secondary" : "bg-success"}`}
                            >
                              {b.status || "Confirmed"}
                            </span>
                          </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex flex-column gap-1">
                            ...
                            <button
                              onClick={() =>
                                handleDelete(std.id, "train", std.fullName)
                              }
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              PROFESSIONAL TRAINING & WORKFORCE SOLUTIONS
                            </p>
                            ...
                            <h3 style={{ fontSize: "28px", color: "#d9534f" }}>
                              {std.course}
                            </h3>
                            ...
                            >
                              ...
                              <div style={{ textAlign: "center" }}>
                                ...
                                >
                                  <QRCodeSVG
                                    value={`https://avaglobal.com/verify/${std.id}`}
                                    size={70}
                                  />
                                </div>
                                <p
        ...
        <div className="mt-5 p-4 bg-white rounded-4 shadow-sm border-top border-warning border-4">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h4 className="fw-bold mb-0 text-dark">
              <Globe className="me-2 text-warning" /> CBI & Residency
              Applications
            </h4>
              ...
              <tbody>
                {cbiRequests.map((req) => (
                  ...
                  >
                    ...
                    <td>
                      <small className="fw-semibold">{req.service}</small>
                    </td>
                    <td>
                      {req.timestamp
        ...
        {activeTab === "finance" && (
          <div className="card border-0 shadow-sm rounded-4 bg-white p-4">
            <h5 className="fw-bold mb-4 d-flex align-items-center gap-2">
              <Wallet /> Revenue Tracker (Realtime)
            </h5>
            <div className="row g-3">
              <div className="col-md-6">
                <div className="p-4 border rounded-4 bg-light d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <h2 className="text-success fw-bold">
                      ₦{(applications.length * 100.0).toLocaleString()}
                    </h2>
                  </div>
              ...
              <div className="col-md-6">
                <div className="p-4 border rounded-4 bg-light d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <h2 className="fw-bold text-dark">₦15,000</h2>
                  </div>
        ...
        {view === "admin" && (
          <div
            className="card-body p-0 bg-white text-dark overflow-hidden"
            style={{ height: "88vh", borderRadius: "15px" }}
          >
            <div className="d-flex h-100">
              {/* --- SIDEBAR NAVIGATION --- */}
              <div
                className="bg-dark p-3 d-flex flex-column gap-2 shadow-lg"
                style={{ width: "280px" }}
              >
                <div className="text-white mb-4 px-3 py-2 border-bottom border-secondary border-opacity-50">
                  ...
                  <small
                    className="opacity-50 text-uppercase fw-bold"
                    style={{ fontSize: "10px" }}
                  >
                    Management Suite
                  </small>
                ...
                <button
                  onClick={() => setActiveTab("overview")}
                  className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent transition-all ${activeTab === "overview" ? "bg-primary shadow" : "hover-white-10"}`}
                >
                  <Globe
                    size={20}
                    className={
                      activeTab === "overview" ? "text-white" : "text-warning"
                    }
                  />
                  <span>Dashboard</span>
                </button>
                ...
                <button
                  ...
                  className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent transition-all ${activeTab === "inventory" ? "bg-success shadow" : "hover-white-10"}`}
                >
                  <CreditCard
                    size={20}
                    className={
                      activeTab === "inventory" ? "text-white" : "text-success"
                    }
                  />
                ...
                <button
                  onClick={() => setActiveTab("bookings")}
                  className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent transition-all ${activeTab === "bookings" ? "bg-primary shadow" : "hover-white-10"}`}
                >
                  <Plane
                    size={20}
                    className={
                      activeTab === "bookings" ? "text-white" : "text-info"
                    }
                  />
                  <span>Live Bookings</span>
                </button>
                ...
                <button
                  ...
                  className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent transition-all ${activeTab === "refunds" ? "bg-warning text-dark shadow" : "hover-white-10"}`}
                >
                  <RefreshCcw
                    size={20}
                    className={
                      activeTab === "refunds" ? "text-dark" : "text-warning"
                    }
                  />
                ...
                <button
                  onClick={() => setActiveTab("finance")}
                  className={`nav-link text-white d-flex align-items-center gap-3 p-3 rounded-3 border-0 bg-transparent transition-all ${activeTab === "finance" ? "bg-danger shadow" : "hover-white-10"}`}
                >
                  <Banknote
                    size={20}
                    className={
                      activeTab === "finance" ? "text-white" : "text-success"
                    }
                  />
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <div className="input-group w-50 shadow-sm rounded-pill overflow-hidden">
                    ...
                    <input
                      ...
                      placeholder="Search by Passenger, Ticket ID or Route..."
                    />
                  </div>
                        ...
                        <div className="card border-0 shadow-sm p-4 rounded-4">
                          ...
                          <div className="mb-3">
                            ...
                            <select className="form-select bg-light border-0 py-2 mt-1">
                              {Object.keys(airlinePrices).map((a) => (
                          ...
                          <div className="mb-3">
                            <label className="small fw-bold text-muted">
                              Serial Ticket Numbers (Comma Separated)
                            </label>
                            <textarea
                            ...
                            <p className="small text-muted mt-2">
                              Tickets added here remain hidden until a customer
                              completes payment.
                            </p>
                          </div>
                          <button className="btn btn-primary w-100 fw-bold rounded-pill py-2">
                            PUSH TO MARKET
                          </button>
                        </div>
                      </div>
                            ...
                            <table className="table table-hover align-middle">
                              ...
                              <tbody className="small">
                                <tr>
                                  <td>Air Peace</td>
                                  <td>
                                    <code className="text-dark">AP-9920-X</code>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>Max Air</td>
                                  <td>
                                    <code className="text-dark">MX-1102-A</code>
                                  </td>
                                  <td>
                  ...
                  <div className="card border-0 shadow-sm p-4 rounded-4 animate__animated animate__fadeIn">
                    <div className="d-flex justify-content-between align-items-center mb-4">
                      <h5 className="fw-bold mb-0 text-danger d-flex align-items-center gap-2">
                        <AlertTriangle size={20} /> Rejection & Refund
                        Processing
                      </h5>
                    ...
                    <div className="table-responsive">
                      <table className="table align-middle">
                        ...
                        <tbody className="small">
                          <tr>
                            ...
                            <td>
                              <div className="d-flex gap-2">
                                <button className="btn btn-sm btn-success rounded-pill px-3 fw-bold">
                                  Approve & Restock
                                </button>
                      ...
                      <div className="alert alert-info border-0 bg-info bg-opacity-10 mt-3 py-2 small">
                        <strong>System Logic:</strong> Approving a refund
                        automatically returns the Ticket ID to the Inventory for
                        re-sale.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="animate__animated animate__fadeIn">
                    <div className="card border-0 shadow-sm p-4 rounded-4 bg-white">
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-4 text-dark border-bottom pb-3">
                        ...
                        <span className="badge bg-danger bg-opacity-10 text-danger rounded-pill px-3 py-2 border border-danger border-opacity-25">
                          <RefreshCw size={14} className="me-1" /> Live
                          Synchronization
                        </span>
                      </div>
                        ...
                        <div className="col-md-6">
                          <div className="p-4 border rounded-4 bg-light shadow-sm">
                            ...
                            <label className="small fw-bold text-muted mb-2">
                              Enter 10 Ticket Numbers (Comma separated)
                            </label>
                            <textarea
                              className="form-control border-0 shadow-sm p-3 mb-3"
                              rows="5"
                            ...
                            <div className="mt-4 p-3 rounded-3 bg-secondary bg-opacity-25 border border-secondary">
                              <div className="d-flex gap-2 align-items-start">
                                ...
                                <p className="small mb-0 text-white-50">
                                  <strong>Auto-Process:</strong> Tickets are
                                  only revealed to customers in their dashboard
                ...
                <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
                  <div className="card-header bg-white py-3 border-bottom border-light">
                    <h5 className="mb-0 fw-bold text-dark text-start">
                      {activeTab === "bookings"
                        ? "Active Flight Bookings"
                        : "Pending Refund Settlements"}
                    </h5>
                  </div>
                  <div className="table-responsive">
                        ...
                        <tr>
                          <td className="ps-4 py-3">
                            ...
                            <div className="small text-muted">
                              <Globe size={12} /> ibrahim@arewa.com
                            </div>
                            <div className="small text-muted">
                              +234 803 000 1111
                            </div>
                          ...
                          <td>
                            ...
                            <div className="small text-dark fw-bold bg-light d-inline-block px-2 rounded">
                              Ticket ID: AV-1022
                            </div>
                            <div className="x-small text-muted mt-1">
                              Date: 12th Feb 2026 | Airline: Air Peace
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <span
                              className={`badge rounded-pill px-3 py-2 ${activeTab === "refunds" ? "bg-warning text-dark" : "bg-success bg-opacity-10 text-success border border-success"}`}
                            >
                              {activeTab === "refunds"
                                ? "Refund Pending"
                                : "Confirmed"}
                          ...
                          <td className="text-center">
                            <div className="btn-group shadow-sm rounded-3">
                              <button
                                className="btn btn-white border btn-sm p-2"
                  ...
                  <div className="row mt-4 g-4 animate__animated animate__fadeIn">
                    <div className="col-md-8">
                      <div className="card border-0 shadow-sm p-4 rounded-4 text-start">
                        ...
                        <div
                          className="bg-light rounded-3 d-flex align-items-end justify-content-between p-3"
                          style={{ height: "200px" }}
                        >
                ...
                <div className="modal-body p-4 bg-light">
                  <div className="row g-3">
                    ...
                    <div className="col-12 bg-white p-2 border rounded">
                      ...
                      <p className="mb-0">
                        {selectedCBI.address || "No address provided"}
                      </p>
                    </div>
                    ...
                    <div className="col-12 bg-warning bg-opacity-10 p-3 rounded">
                      ...
                      <p className="mb-0 fst-italic">
                        "{selectedCBI.message || "No additional notes."}"
                      </p>
                    </div>
                  </div>
                </div>
