...
import {
  ...
  Briefcase, Globe, Calendar, ShieldCheck, Check
} from "lucide-react";
...
const CourseApplicationForm = ({ showCourseForm, setShowCourseForm, coursesData }) => {
  ...
  const [applicationData, setApplicationData] = useState({
    ...
    residenceCountry: "Nigeria", address: "", job: "", jobCountry: "",
      ...
      <div className="card border-0 w-100 mx-auto" style={{ maxWidth: "900px", borderRadius: "24px", overflow: "hidden", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.5)" }}>
        ...
        {loadingPortal ? (
          ...
          <div className="text-center py-5 bg-white px-4">
            ...
            <button onClick={() => setShowCourseForm(false)} className="btn btn-danger px-5 py-2 rounded-pill mt-3 fw-bold">Back Home</button>
          </div>
        ) : (
              ...
              <div ref={receiptRef} className="p-4 p-md-5 text-dark text-start bg-white" style={{ border: "15px solid #1a1a1a" }}>
                ...
                <div className="row g-4 mb-4 mt-2 bg-light p-4 rounded-4 mx-0 border">
                  <div className="col-md-3">
                    <img src={photoPreview} alt="Student" style={{ width: "150px", height: "185px", objectFit: "cover" }} className="rounded-3 shadow-lg" />
                  </div>
                  <div className="col-md-6">
                    ...
                    <table className="table table-sm table-borderless uppercase small">
                      <tbody>
                        ...
                        <tr><td className="fw-bold">NIN Number:</td><td>{applicationData.nin}</td></tr>
                  ...
                  <div className="col-md-3 text-center border-start">
                    ...
                    <p className="mt-2 fw-bold uppercase" style={{ fontSize: "8px" }}>Verify Receipt</p>
                  </div>
                </div>
                ...
                <div className="bg-dark p-4 rounded-4 text-white d-flex justify-content-between align-items-center mb-4 shadow-lg">
                  <div>
                    ...
                    <p className="small text-muted mb-0 uppercase tracking-widest">Status: Payment Verified Successful</p>
                  </div>
              ...
              <div className="row g-0">
                ...
                <div className="col-md-9 p-4 p-md-5 bg-white text-dark text-start">
                  <form className="row g-3" onSubmit={handleFormSubmit}>
                    ...
                    <div className="col-md-4"><label className="form-label small fw-bold">Gender</label><select name="gender" value={applicationData.gender} onChange={handleChange} className="form-select" required><option value="">Select</option><option value="Male">Male</option><option value="Female">Female</option></select></div>
                    ...
                    <div className="col-md-6"><label className="form-label small fw-bold">Credentials (Optional)</label><input type="file" name="resumeFile" className="form-control" onChange={handleFileChange} /></div>

                    <div className="col-12 mt-4">
                      <button type="submit" className="btn btn-warning w-100 py-3 fw-black rounded-pill shadow-lg text-uppercase tracking-widest">PROCEED TO PAYMENT <ArrowRight size={20} className="ms-2" /></button>
                    </div>
                  </form>
                </div>
              </div>
